const processData = (i) => {
  if (
    ...
    i.getAttribute("href").toLowerCase().includes("/wiki/") &&
    ...
    !i.getAttribute("href").toLowerCase().includes("bolt_browser") &&
    ...
    !i.getAttribute("href").toLowerCase().includes("corporation") &&
    ...
    !i.getAttribute("href").toLowerCase().includes("symbian_") &&
    ...
    i.getAttribute("href") !== "/wiki/Emacs/W3" &&
    i.getAttribute("href") !== "/wiki/GNU" &&
